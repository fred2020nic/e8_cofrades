...
<div class="card card-outline card-primary">
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="?page=cofrades_aux/manage_localidad" class="btn btn-flat btn-primary"><span class="fas fa-plus"></span> Crear Producto</a>
		</div>
	</div>
	<div class="card-body">
			...
			<div class="container-fluid">
				<table class="table table-bordered table-stripped">
					...
					<tbody>
						<?php
						$i = 1;
						$qry = $conn->query("select l.*, pr.des_provincia  as provincia from `localidad` l inner JOIN provincia pr on l.provincia_id = pr.id where l.delete_flag = 0 order by ( l. `name`) asc ");
